...
export default function UnpaidHistoryComponent() {
  return (
      ...
      <div className="body flex flex-col gap-4">
        <div className="flex flex-row gap-2">
          <div className="rounded-full bg-[#F6F6F6] w-[45px] h-[45px] flex items-center justify-center">
            <Image src="/src/icon/UnpaidCalendar.svg" alt="" width={24} height={24} />
          </div>
        ...
        <div className="flex flex-row gap-2">
          <div className="rounded-full bg-[#F6F6F6] w-[45px] h-[45px] flex items-center justify-center">
            <Image src="/src/icon/UnpaidTicket.svg" alt="" width={24} height={24} />
          </div>
          <div className="flex flex-col ">
        ...
        <div className="flex flex-row gap-2">
          <div className="rounded-full bg-[#F6F6F6] w-[45px] h-[45px] flex items-center justify-center">
            <Image src="/src/icon/UnpaidCard.svg" alt="" width={24} height={24} />
          </div>
          <div className="flex flex-col">
